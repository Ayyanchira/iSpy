...
% 2. test each image
timeLimitSec = 60;      % 60 second time limit
xLoadTime = 0;          % time spent loading x variable [60 seconds max]
searchTime = 0;         % time spent searching [60 seconds max]
pt = 0;                 % points
...
for i = 1 : setN
    ...
    for j = objectI0 : objectI1
        ...
        [r,c] = i_spy(o_im, b_im, x);               % run search
%         [r,c]=mytest1(b_im,o_im,x);
